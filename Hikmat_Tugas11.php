 ...
 * Model biasanya berupa class PHP yang mewakili tabel dalam database.
 * 
 * B. View adalah bagian yang bertanggung jawab untuk menampilkan data ke user. View biasanya berupa file HTML atau Blade template.
 * 
