<?php
    ...
    //      Migration adalah cara untuk membuat dan mengubah tabel-tabel di database dengan menggunakan kode PHP.
    ...
    // Langkah-langkah :
    // 1. php artisan make:migration nama_migration
    ...
    // 2. Setelah membuat file migration jangan lupa untuk mengubah data di .env seperti berikut :
    //         DB_CONNECTION=mysql
    //         DB_HOST=127.0.0.1
    //         DB_PORT=3306
    //         DB_DATABASE=belajar-laravel (sesuaikan dengan nama database yg dibuat di localhost)
    //         DB_USERNAME=root
    //         DB_PASSWORD=
    ...
    //      Seeder adalah cara untuk mengisi tabel-tabel di database dengan data palsu yang kita buat sendiri. Dengan seeder, kita bisa
    ...
    // Langkah-langkah :
    // 1. php artisan make:seeder nama_seeder
    //    Perintah ini akan membuat file seeder di folder database/seeders dengan nama yang kita beri. 
    //    Di dalam file seeder, kita bisa menulis kode PHP yang mengisi data ke tabel di database.
    // 2. Setelah membuat file seeder, dapat diisi code seperti berikut :
    //      <?php
    ...
    //                  }
    //               }
    // 3. Selanjutnya kita bisa menjalankan seeder dengan mengetik perintah (php artisan db:seed) di terminal.
    ...
    //      MVC (Model-View-Controller), MVC Laravel Framework adalah cara untuk membagi aplikasi web kita menjadi tiga bagian utama,
    // yaitu model, view, dan controller. Dengan MVC, kita bisa membuat aplikasi web yang rapi, modular, dan mudah dipelihara.
    //    1) Model adalah bagian yang mengurus data dan logika aplikasi web kita. Model bisa berkomunikasi dengan database dengan
    //       menggunakan fitur Eloquent ORM, yang bisa membuat kode PHP kita lebih elegan dan ekspresif.
    //       a) Untuk membuat model dengan mengetik perintah (php artisan make:model nama_model) di terminal. Perintah ini akan membuat
    ...
    //       b) Setelah membuat file model, dapat diisi code seperti berikut :
                // <?php
                ...
                //     use HasFactory;
                // }
        //   c) Selanjutnya kita bisa menjalankan code di file web pada routes untuk menghubungkan ke URL dengan code berikut :
                // <?php
                ...
                //     return 'Hello World';
                // });
    //       d) Selanjutnya kita bisa menjalankannya dengan mengetik perintah (php artisan serve) di terminal. 
    ...
    //    2) View adalah bagian yang menampilkan data dan antarmuka pengguna aplikasi web kita. View bisa menggunakan fitur
    //       template engine Blade, yang bisa membuat kode HTML kita lebih sederhana dan kuat.
    //       a) Untuk membuat view dengan membuat file dengan ekstensi (.blade.php) di folder resources/views. Di dalam file view,
    ...
    //    3) Controller adalah bagian yang mengatur alur aplikasi web kita dan menghubungkan model dan view.
    ...
    //       a) Untuk membuat controller dengan mengetik perintah (php artisan make:controller nama_controller) di terminal.
