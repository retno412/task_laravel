 ...
 */
 ...
 /* Kemudian membuat database migration dengan menjalankan perintah: 'php artisan make:migration create_student_table'
 * Setelah itu, membuat database seeding dengan menjalankan perintah: 'php artisan make:seeder StudentSeeder'
 ...
 *    Catatan:
 *    - ketika pengguna mengakses URL '/greeting{id}', server akan merespons dengan mengirimkan teks "Hi, Akbar !" sebagai halaman web.
 *      Nama yang muncul sesuai id yang kita masukkan dan server akan mengakses id yg menghubungkan nama di database yang nantinya akan memunculkan nama seperti "Akbar" seperti contoh diatas.              
 */ 
?>